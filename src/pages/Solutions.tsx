...
const Solutions: React.FC = () => {
  const aiFeatures = [
    {
      ...
      description:
        "AI-powered workflows that learn from your business patterns and automate repetitive tasks.",
    },
    {
      icon: <TrendingUp className="w-8 h-8" />,
      title: "Predictive Analytics",
      description:
        "Advanced forecasting and trend analysis to help you make data-driven decisions.",
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "Real-time Processing",
      description:
        "Lightning-fast data processing and instant insights for immediate business impact.",
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "Smart Security",
      description:
        "AI-enhanced security protocols that adapt to threats and protect your data.",
    },
  ];
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        "Streamline operations and improve productivity by up to 60%",
    },
    {
          ...
          <div className="text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
                Transform your business operations with intelligent solutions
                that adapt, learn, and grow with your company. Experience the
                future of business management today.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our solutions leverage cutting-edge artificial intelligence to
              provide unprecedented insights and automation capabilities.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From startups to enterprise corporations, we have the perfect
              solution tailored to your business needs and growth stage.
            </p>
          </motion.div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience measurable benefits that drive real business growth and
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              ...
              their operations with our AI-powered solutions.
            </p>
