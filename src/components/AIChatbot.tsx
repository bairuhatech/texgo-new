  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#ff9800] rounded-full shadow-2xl flex items-center justify-center text-deep-black hover:bg-[#18a762] transition-all duration-300"
