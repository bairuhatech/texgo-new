...
export type Language = 'en' | 'ar' | 'ig' | 'es' | 'fr' | 'de' | 'zh' | 'ja' | 'pt' | 'ru' | 'hi';
...
const translations = {
  ...
  es: {
    ...
    hero: {
      ...
      subtitle: 'Soluciones empresariales completas impulsadas por IA que incluyen contabilidad, inventario, nómina, comercio electrónico y gestión empresarial - todo unificado en una plataforma inteligente.',
    ...
    features: {
      ...
      subtitle: 'Suite integral de herramientas inteligentes diseñadas para automatizar, optimizar y revolucionar cada aspecto de las operaciones de tu negocio.',
      cta: 'Explorar Todas las Características',
      ready: '¿Listo para transformar tu negocio con soluciones impulsadas por IA?',
      items: [
        {
          title: 'Suite Completa de Contabilidad',
          description: 'Contabilidad automatizada y seguimiento financiero con insights impulsados por IA'
        },
        {
          title: 'Gestión Inteligente de Inventario',
          description: 'Monitoreo de stock en tiempo real con análisis predictivo'
        },
        {
          title: 'Gestión de Nómina y RRHH',
          description: 'Sistema automatizado de procesamiento de salarios y gestión de empleados'
        },
        {
          title: 'Herramientas Financieras Integrales',
          description: 'Presupuestación avanzada, pronósticos y planificación financiera'
        },
        {
          title: 'Gestión de Compras y Ventas',
          description: 'Soluciones automatizadas de adquisiciones y seguimiento de ventas'
        },
        {
          title: 'Sistema de Punto de Venta',
          description: 'Procesamiento de pagos integrado y gestión de transacciones'
        },
        {
          title: 'App de Reportes Ejecutivos',
          description: 'Insights empresariales en tiempo real y dashboards interactivos'
        },
        {
          title: 'App de Toma de Pedidos',
          description: 'Procesamiento simplificado de pedidos de clientes y gestión'
        },
        {
          title: 'Sistemas de Visualización para Clientes y Chefs',
          description: 'Plataformas de coordinación perfecta entre cocina y servicio'
        },
        {
          title: 'Pedidos Inteligentes Basados en Menú',
          description: 'Recomendaciones impulsadas por IA y características de personalización'
        },
        {
          title: 'Plataforma de Comercio Electrónico Lista',
          description: 'Solución de tienda online completamente integrada con características avanzadas'
        },
        {
          title: 'Software Completo de Marketplace',
          description: 'Venta multicanal con control centralizado de inventario'
        }
      ]
    },
    industries: {
      title: 'Soluciones Específicas por Industria',
      subtitle: 'Soluciones personalizadas diseñadas para satisfacer los desafíos únicos y requisitos de industrias específicas con flujos de trabajo especializados y necesidades de cumplimiento.',
      healthcare: {
        title: 'Salud',
        subtitle: 'Sistema de Gestión Hospitalaria',
        description: 'Solución completa de administración sanitaria y gestión financiera diseñada para instalaciones médicas modernas.',
        learnMore: 'Saber Más'
      },
      education: {
        title: 'Educación',
        subtitle: 'Sistema de Gestión de Aprendizaje',
        description: 'Plataforma educativa integral con contabilidad integrada y administración para instituciones educativas.',
        learnMore: 'Saber Más'
      },
      enterprise: {
        title: 'Empresarial',
        subtitle: 'Soluciones Empresariales Escalables',
        description: 'Soluciones de nivel empresarial diseñadas para operaciones comerciales a gran escala en múltiples industrias.',
        learnMore: 'Saber Más'
      },
      ...
      scheduleDemoText: 'Programa una demo personalizada para ver cómo nuestra solución puede transformar tus operaciones.',
      scheduleDemo: 'Programar Demo'
    },
    globalMap: {
      title: 'Presencia Global',
      subtitle: 'Confiado por empresas mundialmente, TaxGo Global sirve a clientes en todos los continentes con soluciones localizadas y soporte 24/7.',
    ...
    contact: {
      ...
      subtitle: 'Ponte en contacto con nuestros expertos para discutir tus necesidades específicas y descubrir cómo TaxGo Global puede revolucionar las operaciones de tu negocio.',
      ...
      thankYou: '¡Gracias!',
      successMessage: 'Tu mensaje ha sido enviado exitosamente. Nuestro equipo se pondrá en contacto contigo dentro de 24 horas.',
      sendAnother: 'Enviar Otro Mensaje'
    },
    footer: {
      description: 'Revolucionando la gestión empresarial con soluciones impulsadas por IA. Desde contabilidad hasta gestión empresarial, proporcionamos herramientas integrales que ayudan a las empresas a prosperar en la era digital.',
      stayUpdated: 'Mantente Actualizado',
      newsletterText: 'Obtén las últimas actualizaciones sobre nuevas características, insights de la industria y ofertas exclusivas.',
  ...
  fr: {
    ...
    hero: {
      ...
      subtitle: 'Solutions commerciales complètes alimentées par IA incluant comptabilité, inventaire, paie, e-commerce et gestion d\'entreprise - tout unifié dans une plateforme intelligente.',
    ...
    features: {
      ...
      subtitle: 'Suite complète d\'outils intelligents conçus pour automatiser, optimiser et révolutionner chaque aspect des opérations de votre entreprise.',
      cta: 'Explorer Toutes les Fonctionnalités',
      ready: 'Prêt à transformer votre entreprise avec des solutions alimentées par IA?',
      items: [
        {
          title: 'Suite Comptable Complète',
          description: 'Tenue de livres automatisée et suivi financier avec insights alimentés par IA'
        },
        {
          title: 'Gestion Intelligente des Stocks',
          description: 'Surveillance des stocks en temps réel avec analyses prédictives'
        },
        {
          title: 'Gestion de la Paie et RH',
          description: 'Système automatisé de traitement des salaires et de gestion des employés'
        },
        {
          title: 'Outils Financiers Complets',
          description: 'Budgétisation avancée, prévisions et planification financière'
        },
        {
          title: 'Gestion des Achats et Ventes',
          description: 'Solutions automatisées d\'approvisionnement et de suivi des ventes'
        },
        {
          title: 'Système de Point de Vente',
          description: 'Traitement des paiements intégré et gestion des transactions'
        },
        {
          title: 'App de Rapports Exécutifs',
          description: 'Insights commerciaux en temps réel et tableaux de bord interactifs'
        },
        {
        ...
        },
        {
          ...
          description: 'Plateformes de coordination fluide entre cuisine et service'
        },
        {
          title: 'Commandes Intelligentes Basées sur Menu',
          description: 'Recommandations alimentées par IA et fonctionnalités de personnalisation'
        },
        {
          title: 'Plateforme E-commerce Prête à l\'Emploi',
          description: 'Solution de boutique en ligne entièrement intégrée avec fonctionnalités avancées'
        },
        {
    ...
    industries: {
      ...
      subtitle: 'Solutions sur mesure conçues pour répondre aux défis uniques et exigences d\'industries spécifiques avec des flux de travail spécialisés et des besoins de conformité.',
      healthcare: {
        title: 'Santé',
        subtitle: 'Système de Gestion Hospitalière',
        description: 'Solution complète d\'administration des soins de santé et de gestion financière conçue pour les installations médicales modernes.',
        learnMore: 'En Savoir Plus'
      },
      education: {
        title: 'Éducation',
        subtitle: 'Système de Gestion de l\'Apprentissage',
        description: 'Plateforme éducative complète avec comptabilité intégrée et administration pour les institutions éducatives.',
        learnMore: 'En Savoir Plus'
      },
      enterprise: {
        title: 'Entreprise',
        subtitle: 'Solutions Commerciales Évolutives',
        description: 'Solutions de niveau entreprise conçues pour des opérations commerciales à grande échelle dans plusieurs industries.',
        learnMore: 'En Savoir Plus'
      },
      ...
      scheduleDemoText: 'Programmez une démo personnalisée pour voir comment notre solution peut transformer vos opérations.',
      scheduleDemo: 'Programmer une Démo'
    },
    globalMap: {
      title: 'Présence Mondiale',
      subtitle: 'Approuvé par des entreprises dans le monde entier, TaxGo Global sert des clients sur tous les continents avec des solutions localisées et un support 24/7.',
    ...
    contact: {
      ...
      subtitle: 'Contactez nos experts pour discuter de vos besoins spécifiques et découvrir comment TaxGo Global peut révolutionner les opérations de votre entreprise.',
      ...
      thankYou: 'Merci!',
      successMessage: 'Votre message a été envoyé avec succès. Notre équipe vous contactera dans les 24 heures.',
      sendAnother: 'Envoyer un Autre Message'
    },
    footer: {
      description: 'Révolutionner la gestion d\'entreprise avec des solutions alimentées par IA. De la comptabilité à la gestion d\'entreprise, nous fournissons des outils complets qui aident les entreprises à prospérer à l\'ère numérique.',
      stayUpdated: 'Restez Informé',
      newsletterText: 'Obtenez les dernières mises à jour sur les nouvelles fonctionnalités, les insights de l\'industrie et les offres exclusives.',
  ...
  de: {
    ...
    hero: {
      ...
      subtitle: 'Komplette KI-gestützte Geschäftslösungen einschließlich Buchhaltung, Inventar, Gehaltsabrechnung, E-Commerce und Unternehmensmanagement - alles vereint in einer intelligenten Plattform.',
    ...
    features: {
      ...
      subtitle: 'Umfassende Suite intelligenter Tools, die entwickelt wurden, um jeden Aspekt Ihrer Geschäftsabläufe zu automatisieren, zu optimieren und zu revolutionieren.',
      cta: 'Alle Funktionen erkunden',
      ready: 'Bereit, Ihr Unternehmen mit KI-gestützten Lösungen zu transformieren?',
      items: [
        {
          title: 'Komplette Buchhaltungssuite',
          description: 'Automatisierte Buchführung und Finanzverfolgung mit KI-gestützten Einblicken'
        },
        {
        ...
        },
        {
          ...
          description: 'Automatisiertes Gehaltsabrechnungssystem und Mitarbeiterverwaltung'
        },
        {
        ...
        },
        {
          ...
          description: 'Automatisierte Beschaffungs- und Vertriebsverfolgungslösungen'
        },
        {
          title: 'Kassensystem',
          description: 'Integrierte Zahlungsabwicklung und Transaktionsmanagement'
        },
        {
          title: 'Executive Reporting App',
        ...
        },
        {
          ...
          description: 'Vollständig integrierte Online-Shop-Lösung mit erweiterten Funktionen'
        },
        {
          title: 'Komplette Marktplatz-Software',
          description: 'Multi-Channel-Verkauf mit zentralisierter Bestandskontrolle'
        }
      ]
    },
    industries: {
      title: 'Branchenspezifische Lösungen',
      subtitle: 'Maßgeschneiderte Lösungen, die darauf ausgelegt sind, die einzigartigen Herausforderungen und Anforderungen spezifischer Branchen mit spezialisierten Arbeitsabläufen und Compliance-Anforderungen zu erfüllen.',
      healthcare: {
        title: 'Gesundheitswesen',
        subtitle: 'Krankenhaus-Management-System',
        description: 'Komplette Gesundheitsverwaltungs- und Finanzmanagement-Lösung für moderne medizinische Einrichtungen.',
        learnMore: 'Mehr erfahren'
      },
      education: {
        title: 'Bildung',
        subtitle: 'Lernmanagementsystem',
        description: 'Umfassende Bildungsplattform mit integrierter Buchhaltung und Verwaltung für Bildungseinrichtungen.',
        learnMore: 'Mehr erfahren'
      },
      enterprise: {
        title: 'Unternehmen',
        subtitle: 'Skalierbare Geschäftslösungen',
        description: 'Unternehmensklasse-Lösungen für großangelegte Geschäftsabläufe in verschiedenen Branchen.',
        learnMore: 'Mehr erfahren'
      },
      ...
      scheduleDemoText: 'Planen Sie eine personalisierte Demo, um zu sehen, wie unsere Lösung Ihre Abläufe transformieren kann.',
      scheduleDemo: 'Demo planen'
    },
    globalMap: {
      title: 'Globale Präsenz',
      subtitle: 'Vertraut von Unternehmen weltweit, bedient TaxGo Global Kunden auf allen Kontinenten mit lokalisierten Lösungen und 24/7-Support.',
    ...
    contact: {
      ...
      subtitle: 'Kontaktieren Sie unsere Experten, um Ihre spezifischen Bedürfnisse zu besprechen und zu erfahren, wie TaxGo Global Ihre Geschäftsabläufe revolutionieren kann.',
      ...
      successMessage: 'Ihre Nachricht wurde erfolgreich gesendet. Unser Team wird sich innerhalb von 24 Stunden bei Ihnen melden.',
      sendAnother: 'Weitere Nachricht senden'
    },
    footer: {
      description: 'Revolutionierung des Unternehmensmanagements mit KI-gestützten Lösungen. Von der Buchhaltung bis zum Unternehmensmanagement bieten wir umfassende Tools, die Unternehmen helfen, im digitalen Zeitalter zu gedeihen.',
      stayUpdated: 'Auf dem Laufenden bleiben',
      newsletterText: 'Erhalten Sie die neuesten Updates zu neuen Funktionen, Brancheneinblicken und exklusiven Angeboten.',
  ...
  zh: {
    ...
    hero: {
      ...
      subtitle: '完整的AI驱动业务解决方案，包括会计、库存、工资、电子商务和企业管理 - 全部统一在一个智能平台中。',
      ctaPrimary: '体验AI会计',
      ctaSecondary: '安排现场演示',
      trustIndicators: {
        clients: '500+全球客户',
    ...
    features: {
      title: 'AI驱动的商业解决方案',
      subtitle: '全面的智能工具套件，旨在自动化、优化和革命化您业务运营的每个方面。',
      cta: '探索所有功能',
    ...
    industries: {
      title: '行业特定解决方案',
      subtitle: '量身定制的解决方案，旨在满足特定行业的独特挑战和要求，具有专门的工作流程和合规需求。',
      healthcare: {
        title: '医疗保健',
        subtitle: '医院管理系统',
    ...
    globalMap: {
      title: '全球存在',
      subtitle: '受到全球企业信赖，TaxGo Global为各大洲的客户提供本地化解决方案和24/7支持。',
    ...
    contact: {
      title: '准备转变您的业务？',
      subtitle: '联系我们的专家讨论您的具体需求，了解TaxGo Global如何革命化您的业务运营。',
      getInTouch: '联系我们',
      fullName: '全名',
      emailAddress: '电子邮件地址',
      companyName: '公司名称',
    ...
    footer: {
      description: '用AI驱动的解决方案革命化企业管理。从会计到企业管理，我们提供帮助企业在数字时代蓬勃发展的综合工具。',
      stayUpdated: '保持更新',
  ...
  ja: {
    ...
    hero: {
      ...
      subtitle: '会計、在庫、給与、eコマース、企業管理を含む完全なAI駆動ビジネスソリューション - すべて1つのインテリジェントプラットフォームに統合。',
      ctaPrimary: 'AI会計を体験',
    ...
    features: {
      ...
      subtitle: 'ビジネス運営のあらゆる側面を自動化、最適化、革新するために設計された包括的なインテリジェントツールスイート。',
      cta: 'すべての機能を探索',
      ...
      items: [
        ...
        },
        {
          ...
          description: 'リアルタイムビジネスインサイトとインタラクティブダッシュボード'
        },
        {
          title: '注文取得アプリ',
        ...
        },
        {
          ...
          description: '高度な機能を備えた完全統合オンラインストアソリューション'
        },
        {
    ...
    industries: {
      title: '業界固有ソリューション',
      subtitle: '専門的なワークフローとコンプライアンス要件を持つ特定業界の独特な課題と要件を満たすように設計されたカスタマイズソリューション。',
      healthcare: {
        title: 'ヘルスケア',
        subtitle: '病院管理システム',
        description: '現代医療施設向けに設計された完全なヘルスケア管理と財務管理ソリューション。',
        learnMore: '詳細を見る'
      },
      education: {
        title: '教育',
        subtitle: '学習管理システム',
        description: '教育機関向けの統合会計と管理を備えた包括的教育プラットフォーム。',
        learnMore: '詳細を見る'
      },
      enterprise: {
        title: 'エンタープライズ',
        subtitle: 'スケーラブルビジネスソリューション',
        description: '複数業界にわたる大規模ビジネス運営向けに設計されたエンタープライズグレードソリューション。',
        learnMore: '詳細を見る'
      },
      successMetrics: '成功指標',
      ...
      scheduleDemoText: 'パーソナライズされたデモをスケジュールして、当社のソリューションがどのように運営を変革できるかをご覧ください。',
      scheduleDemo: 'デモをスケジュール'
    },
    globalMap: {
      title: 'グローバルプレゼンス',
      subtitle: '世界中の企業に信頼され、TaxGo Globalは大陸を越えてローカライズされたソリューションと24/7サポートで顧客にサービスを提供しています。',
    ...
    contact: {
      ...
      subtitle: '専門家にお問い合わせいただき、具体的なニーズについて話し合い、TaxGo Globalがビジネス運営をどのように革命化できるかをご確認ください。',
      getInTouch: 'お問い合わせ',
      fullName: 'フルネーム',
      ...
      thankYou: 'ありがとうございます！',
      successMessage: 'メッセージが正常に送信されました。チームが24時間以内にご連絡いたします。',
      sendAnother: '別のメッセージを送信'
    },
    footer: {
      description: 'AI駆動ソリューションでビジネス管理を革命化。会計から企業管理まで、デジタル時代に企業が繁栄するための包括的ツールを提供します。',
      stayUpdated: '最新情報を受け取る',
      newsletterText: '新機能、業界インサイト、限定オファーの最新アップデートを取得してください。',
  ...
  pt: {
    ...
    hero: {
      ...
      subtitle: 'Soluções empresariais completas alimentadas por IA incluindo contabilidade, inventário, folha de pagamento, e-commerce e gestão empresarial - tudo unificado em uma plataforma inteligente.',
    ...
    features: {
      ...
      subtitle: 'Suíte abrangente de ferramentas inteligentes projetadas para automatizar, otimizar e revolucionar todos os aspectos das operações do seu negócio.',
      cta: 'Explorar Todas as Funcionalidades',
      ready: 'Pronto para transformar seu negócio com soluções alimentadas por IA?',
      items: [
        {
          title: 'Suíte Completa de Contabilidade',
          description: 'Escrituração automatizada e rastreamento financeiro com insights alimentados por IA'
        },
        {
          title: 'Gestão Inteligente de Inventário',
          description: 'Monitoramento de estoque em tempo real com análises preditivas'
        },
        {
          title: 'Gestão de Folha de Pagamento e RH',
          description: 'Sistema automatizado de processamento de salários e gestão de funcionários'
        },
        {
          title: 'Ferramentas Financeiras Abrangentes',
          description: 'Orçamentação avançada, previsões e planejamento financeiro'
        },
        {
          title: 'Gestão de Compras e Vendas',
          description: 'Soluções automatizadas de aquisição e rastreamento de vendas'
        },
        {
          title: 'Sistema de Ponto de Venda',
          description: 'Processamento de pagamentos integrado e gestão de transações'
        },
        {
          title: 'App de Relatórios Executivos',
          description: 'Insights empresariais em tempo real e dashboards interativos'
        },
        {
          title: 'App de Recebimento de Pedidos',
          description: 'Processamento simplificado de pedidos de clientes e gestão'
        },
        {
          title: 'Sistemas de Display para Clientes e Chefs',
          description: 'Plataformas de coordenação perfeita entre cozinha e serviço'
        },
        {
          title: 'Pedidos Inteligentes Baseados em Menu',
          description: 'Recomendações alimentadas por IA e recursos de personalização'
        },
        {
          title: 'Plataforma de E-commerce Pronta',
          description: 'Solução de loja online totalmente integrada com recursos avançados'
        },
        {
          title: 'Software Completo de Marketplace',
          description: 'Vendas multicanal com controle centralizado de inventário'
        }
      ]
    },
    industries: {
      title: 'Soluções Específicas por Indústria',
      subtitle: 'Soluções customizadas projetadas para atender os desafios únicos e requisitos de indústrias específicas com fluxos de trabalho especializados e necessidades de conformidade.',
      healthcare: {
        title: 'Saúde',
        subtitle: 'Sistema de Gestão Hospitalar',
        description: 'Solução completa de administração de saúde e gestão financeira projetada para instalações médicas modernas.',
        learnMore: 'Saiba Mais'
      },
      education: {
        title: 'Educação',
        subtitle: 'Sistema de Gestão de Aprendizagem',
        description: 'Plataforma educacional abrangente com contabilidade integrada e administração para instituições educacionais.',
        learnMore: 'Saiba Mais'
      },
      enterprise: {
        title: 'Empresarial',
        subtitle: 'Soluções Empresariais Escaláveis',
        description: 'Soluções de nível empresarial projetadas para operações empresariais de grande escala em múltiplas indústrias.',
        learnMore: 'Saiba Mais'
      },
      ...
      scheduleDemoText: 'Agende uma demonstração personalizada para ver como nossa solução pode transformar suas operações.',
      scheduleDemo: 'Agendar Demo'
    },
    globalMap: {
      title: 'Presença Global',
      subtitle: 'Confiado por empresas mundialmente, TaxGo Global serve clientes em todos os continentes com soluções localizadas e suporte 24/7.',
    ...
    contact: {
      ...
      subtitle: 'Entre em contato com nossos especialistas para discutir suas necessidades específicas e descobrir como TaxGo Global pode revolucionar suas operações empresariais.',
      ...
      thankYou: 'Obrigado!',
      successMessage: 'Sua mensagem foi enviada com sucesso. Nossa equipe entrará em contato em 24 horas.',
      sendAnother: 'Enviar Outra Mensagem'
    },
    footer: {
      description: 'Revolucionando a gestão empresarial com soluções alimentadas por IA. Da contabilidade à gestão empresarial, fornecemos ferramentas abrangentes que ajudam empresas a prosperar na era digital.',
      stayUpdated: 'Mantenha-se Atualizado',
      newsletterText: 'Receba as últimas atualizações sobre novos recursos, insights da indústria e ofertas exclusivas.',
  ...
  ru: {
    ...
    hero: {
      ...
      subtitle: 'Полные бизнес-решения на базе ИИ, включающие бухгалтерию, складской учет, расчет зарплаты, электронную коммерцию и управление предприятием - все объединено в одной интеллектуальной платформе.',
    ...
    features: {
      ...
      subtitle: 'Комплексный набор интеллектуальных инструментов, разработанных для автоматизации, оптимизации и революционного изменения каждого аспекта операций вашего бизнеса.',
      cta: 'Изучить все функции',
      ready: 'Готовы трансформировать свой бизнес с помощью решений на базе ИИ?',
      items: [
        {
          title: 'Полный бухгалтерский пакет',
          description: 'Автоматизированная бухгалтерия и финансовое отслеживание с аналитикой на базе ИИ'
        },
        {
          title: 'Умное управление складом',
          description: 'Мониторинг запасов в реальном времени с прогнозной аналитикой'
        },
        {
          title: 'Управление зарплатой и HR',
          description: 'Автоматизированная система расчета зарплаты и управления сотрудниками'
        },
        {
          title: 'Комплексные финансовые инструменты',
          description: 'Расширенное бюджетирование, прогнозирование и финансовое планирование'
        },
        {
          title: 'Управление закупками и продажами',
          description: 'Автоматизированные решения для закупок и отслеживания продаж'
        },
        {
          title: 'Система торговых точек',
          description: 'Интегрированная обработка платежей и управление транзакциями'
        },
        {
          title: 'Приложение исполнительной отчетности',
          description: 'Бизнес-аналитика в реальном времени и интерактивные панели'
        },
        {
        ...
        },
        {
          ...
          description: 'Полностью интегрированное решение интернет-магазина с расширенными функциями'
        },
        {
          title: 'Полное программное обеспечение маркетплейса',
          description: 'Многоканальные продажи с централизованным контролем запасов'
        }
      ]
    },
    industries: {
      title: 'Отраслевые решения',
      subtitle: 'Индивидуальные решения, разработанные для удовлетворения уникальных вызовов и требований конкретных отраслей со специализированными рабочими процессами и потребностями в соответствии.',
      healthcare: {
        title: 'Здравоохранение',
        subtitle: 'Система управления больницей',
        description: 'Полное решение для администрирования здравоохранения и финансового управления, разработанное для современных медицинских учреждений.',
        learnMore: 'Узнать больше'
      },
      education: {
        title: 'Образование',
        subtitle: 'Система управления обучением',
        description: 'Комплексная образовательная платформа с интегрированной бухгалтерией и администрированием для образовательных учреждений.',
        learnMore: 'Узнать больше'
      },
      enterprise: {
        title: 'Предприятие',
        subtitle: 'Масштабируемые бизнес-решения',
        description: 'Корпоративные решения, разработанные для крупномасштабных бизнес-операций в различных отраслях.',
        learnMore: 'Узнать больше'
      },
      ...
      scheduleDemoText: 'Запланируйте персонализированную демонстрацию, чтобы увидеть, как наше решение может трансформировать ваши операции.',
      scheduleDemo: 'Запланировать демонстрацию'
    },
    globalMap: {
      title: 'Глобальное присутствие',
      subtitle: 'Доверенная компаниями по всему миру, TaxGo Global обслуживает клиентов на всех континентах с локализованными решениями и поддержкой 24/7.',
    ...
    contact: {
      ...
      subtitle: 'Свяжитесь с нашими экспертами, чтобы обсудить ваши конкретные потребности и узнать, как TaxGo Global может революционизировать операции вашего бизнеса.',
      ...
      thankYou: 'Спасибо!',
      successMessage: 'Ваше сообщение было успешно отправлено. Наша команда свяжется с вами в течение 24 часов.',
      sendAnother: 'Отправить другое сообщение'
    },
    footer: {
      description: 'Революционизируем управление бизнесом с помощью решений на базе ИИ. От бухгалтерии до управления предприятием, мы предоставляем комплексные инструменты, которые помогают бизнесу процветать в цифровую эпоху.',
      stayUpdated: 'Оставайтесь в курсе',
      newsletterText: 'Получайте последние обновления о новых функциях, отраслевых инсайтах и эксклюзивных предложениях.',
  ...
  hi: {
    ...
    hero: {
      ...
      subtitle: 'लेखांकन, इन्वेंटरी, पेरोल, ई-कॉमर्स और उद्यम प्रबंधन सहित संपूर्ण AI-संचालित व्यवसाय समाधान - सभी एक बुद्धिमान प्लेटफॉर्म में एकीकृत।',
    ...
    features: {
      ...
      subtitle: 'आपके व्यवसाय संचालन के हर पहलू को स्वचालित, अनुकूलित और क्रांतिकारी बनाने के लिए डिज़ाइन किए गए बुद्धिमान उपकरणों का व्यापक सूट।',
      cta: 'सभी सुविधाओं का अन्वेषण करें',
      ready: 'AI-संचालित समाधानों के साथ अपने व्यवसाय को रूपांतरित करने के लिए तैयार हैं?',
      items: [
        {
          title: 'संपूर्ण लेखांकन सूट',
          description: 'AI-संचालित अंतर्दृष्टि के साथ स्वचालित पुस्तक रखरखाव और वित्तीय ट्रैकिंग'
        },
        {
    ...
    industries: {
      ...
      subtitle: 'विशेष वर्कफ़्लो और अनुपालन आवश्यकताओं के साथ विशिष्ट उद्योगों की अनूठी चुनौतियों और आवश्यकताओं को पूरा करने के लिए डिज़ाइन किए गए अनुकूलित समाधान।',
      healthcare: {
        title: 'स्वास्थ्य सेवा',
        subtitle: 'अस्पताल प्रबंधन प्रणाली',
        description: 'आधुनिक चिकित्सा सुविधाओं के लिए डिज़ाइन किया गया संपूर्ण स्वास्थ्य सेवा प्रशासन और वित्तीय प्रबंधन समाधान।',
        learnMore: 'और जानें'
      },
      education: {
        title: 'शिक्षा',
        subtitle: 'शिक्षा प्रबंधन प्रणाली',
        description: 'शैक्षिक संस्थानों के लिए एकीकृत लेखांकन और प्रशासन के साथ व्यापक शैक्षिक प्लेटफॉर्म।',
        learnMore: 'और जानें'
      },
      enterprise: {
        title: 'उद्यम',
        subtitle: 'स्केलेबल व्यवसाय समाधान',
        description: 'कई उद्योगों में बड़े पैमाने के व्यवसाय संचालन के लिए डिज़ाइन किए गए उद्यम-ग्रेड समाधान।',
        learnMore: 'और जानें'
      },
      ...
      scheduleDemoText: 'एक व्यक्तिगत डेमो शेड्यूल करें यह देखने के लिए कि हमारा समाधान आपके संचालन को कैसे रूपांतरित कर सकता है।',
      scheduleDemo: 'डेमो शेड्यूल करें'
    },
    globalMap: {
      title: 'वैश्विक उपस्थिति',
      subtitle: 'दुनिया भर के व्यवसायों द्वारा भरोसा किया गया, TaxGo Global स्थानीयकृत समाधानों और 24/7 सहायता के साथ सभी महाद्वीपों में ग्राहकों की सेवा करता है।',
    ...
    contact: {
      ...
      subtitle: 'अपनी विशिष्ट आवश्यकताओं पर चर्चा करने और यह जानने के लिए हमारे विशेषज्ञों से संपर्क करें कि TaxGo Global आपके व्यवसाय संचालन में क्रांति कैसे ला सकता है।',
      ...
      thankYou: 'धन्यवाद!',
      successMessage: 'आपका संदेश सफलतापूर्वक भेजा गया है। हमारी टीम 24 घंटों के अंदर आपसे संपर्क करेगी।',
      sendAnother: 'दूसरा संदेश भेजें'
    },
    footer: {
      description: 'AI-संचालित समाधानों के साथ व्यवसाय प्रबंधन में क्रांति। लेखांकन से उद्यम प्रबंधन तक, हम व्यापक उपकरण प्रदान करते हैं जो व्यवसायों को डिजिटल युग में फलने-फूलने में मदद करते हैं।',
      stayUpdated: 'अपडेट रहें',
      newsletterText: 'नई सुविधाओं, उद्योग अंतर्दृष्टि और विशेष ऑफ़र पर नवीनतम अपडेट प्राप्त करें।',
...
export const AppProvider: React.FC<AppProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (savedLanguage && ['en', 'ar', 'ig', 'es', 'fr', 'de', 'zh', 'ja', 'pt', 'ru', 'hi'].includes(savedLanguage)) {
